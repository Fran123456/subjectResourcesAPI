  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agrega un tutor</h5>
            ...
            <table id="table" class="table">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th width="250" scope="col">Nombre</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$value->descripcion}}</td>
                    ...
                    <td>
                      <a href="{{ route('colaboradores.edit', $value->id) }}" class="btn btn-warning "><i class="far fa-edit"></i></a>
                    </td>

                    <td>
                        <form method="POST" action="{{ route('colaboradores.destroy', $value->id) }}">
                                @csrf
